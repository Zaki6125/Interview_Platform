...
import CodeEditorPanel from '../Pages/CodeEditorPanel'
import OutputPanel from '../Pages/Outputpanel'
import toast from 'react-hot-toast'
import { executeCode } from "../lib/piston";
import confetti from 'canvas-confetti'

function ProblemsPages() {
  const { id } = useParams();
  ...
  const handleProblemChange = (newProblemId) => navigate(`/ProblemPage/${newProblemId}`);
  ...
  const handleRunCode =  async () => {
    ...
    if(result.success)
    {
        ...
        {
            toast.error('Error ocurre in your code Checked your  Output')
        }
    }
    else
    {
